...
export default function ProjectCard({ project }: { project: ProjectMeta }) {
  ...
  const content = (
    <div
      className={`group h-full overflow-hidden rounded-xl border transition ${
        live
    ...
    >
      {project.thumbnail && (
        <img
          ...
          alt=""
          className="h-32 w-full border-b border-neutral-200 object-cover dark:border-neutral-800"
        />
      )}
      <div className="p-5">
